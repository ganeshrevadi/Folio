    ...
    <div className="drop-shadow-xl rounded-sm flex justify-between outline outline-2 outline-slate-700 p-2">
      ...
      <div className="flex flex-row">
        ...
        <div>
          ...
          <button type="button" onClick={() => handleButtonClick('https://www.linkedin.com/in/ganesh-revadi/')} className="text-white bg-slate-700 hover:bg-[#0b66c2]/90 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-sm px-3 py-2.5 text-center inline-flex items-center dark:focus:ring-[#1da1f2]/55 me-2 mb-e">
          ...
          <button type="button" onClick={() => handleButtonClick('https://github.com/ganeshrevadi')} className="text-white bg-slate-700 hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-3 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 me-2 mb-2">
          ...
          <button type="button" onClick={() => handleButtonClick('https://twitter.com/ganeshrevadi16')} className="text-white bg-slate-700 hover:bg-[#0b66c2]/90 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-sm px-3 py-2.5 text-center inline-flex items-center dark:focus:ring-[#1da1f2]/55 me-2 mb-e">
