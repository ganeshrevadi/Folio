  ...
  return <ThemeProvider defaultTheme="dark" storageKey="vite-ui-theme">
    <div className="p-3 flex flex-col justify-between">
      ...
      <div className="flex flex-row justify-center p-7 ">
        <img class="rounded-full w-72 h-72 ring-2 ring-slate-400 " src={logo} alt="image description" />
      </div>
      ...
      <div className="flex justify-center">
        ...
        <button type="button" onClick={() => handleButtonClick('https://www.linkedin.com/in/ganesh-revadi/')} class="text-white focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-sm px-3 py-2.5 text-center inline-flex items-center dark:focus:ring-[#1da1f2]/55 me-2 mb-e">
        ...
        <button type="button" onClick={() => handleButtonClick('https://github.com/ganeshrevadi')} class="text-white  hover:bg-white-100 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-3 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 me-2 mb-e">
        ...
        <button type="button" onClick={() => handleButtonClick('https://twitter.com/ganeshrevadi16')} class="text-white focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-sm px-3 py-2.5 text-center inline-flex items-center dark:focus:ring-[#1da1f2]/55 me-2 mb-e">
